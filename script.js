...
function showChoices(video) {
  ...
  if (video === 'videos/scene0.mp4') {
    ...
    if (!studyState) {
      ...
      choices.innerHTML = `
        <button onclick="sessionStorage.setItem('popularity', (parseInt(sessionStorage.getItem('popularity')) + 1).toString()); updateStateDisplay(); choosePath('videos/scene_chemistry_testoverpc.mp4')">Let Them Cheat</button>
        <button onclick="choosePath('videos/scene_chemistry_testoverp.mp4')">Tell Them No</button>
      `;
    }
    ...
    if (sessionStorage.getItem('breakfast') === 'true') {
      choices.innerHTML += `
        <button onclick="choosePath('videos/scene_finale_sneak.mp4')">Create a Distraction</button>
      `;
    } else {
      choices.innerHTML += `
...
videoPlayer.addEventListener('ended', function() {
  ...
  videoPlayer.play();
    ...
    videoPlayer.load();
    videoPlayer.play();
  } else if (currentVideo === 'videos/scene_finale_fight.mp4' || currentVideo === 'videos/scene_finale_breakfast.mp4') {
    videoSource.src = 'videos/go_ritual.mp4';
    videoPlayer.load();
    videoPlayer.play();
  } else if (currentVideo === 'videos/ending_pop.mp4' || currentVideo === 'videos/ending_evil.mp4' || currentVideo === 'videos/ending_good.mp4') {
    videoSource.src = 'videos/go_credits.mp4';
    videoPlayer.load();
    videoPlayer.play();
}
